...
export const PositionValidationButton = forwardRef<HTMLDivElement>(
  function PositionValidationButton(_props, ref) {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [validationData, setValidationData] = useState<ValidationData | null>(
      null,
    );

    const validateQuery = api.pairs.validatePositionCreation.useQuery(
      undefined,
      {
        enabled: false,
      },
            ...
            <Stack>
              ...
              <Group>
                ...
                <Badge
                  ...
                  variant="outline"
                  color={
                    validationData.averageProfitLoss >= 0 ? "green" : "red"
                  }
                >
              ...
              <Stack>
                ...
                <Table>
                  ...
                  <Table.Tbody>
                    {validationData.topTradingPairs.map(
                      (item, index: number) => (
                        <Table.Tr key={index}>
