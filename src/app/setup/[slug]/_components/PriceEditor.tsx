...
export function PriceEditor({ setup }: PriceEditorProps) {
  ...
  const handlePriceChange = (
    field: "entryPrice" | "takeProfitPrice" | "stopPrice",
    ...
    const timeoutId = setTimeout(() => {
      void updateSetup.mutate({
        ...
        takeProfitPrice:
          field === "takeProfitPrice" ? stringValue : prices.takeProfitPrice,
  ...
  return (
    <SimpleGrid cols={{ base: 2, sm: 4 }} spacing="md">
      ...
      <div>
        <Text className="mt-6 pb-6" size="sm" c="dimmed">
          Risk/Reward
        </Text>
        <Text
          size="xl"
          fw={700}
          c={riskReward && Number(riskReward) >= 2 ? "green" : "yellow"}
        >
